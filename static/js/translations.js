    ...
    constructor() {
        ...
        this.translations = {
            'ar': {
                ...
                'city_Bizerte': 'بنزرت',
                'city_Ariana': 'أريانة',
                'city_Ariana_Soughra': 'أريانة الصغرى',
                'city_Nour_Jaafer': 'نور جعفر',
                'city_Ben_Arous': 'بن عروس',
                'city_La_Marsa': 'المرسى',
                'city_Megrine': 'مقرين',
                'city_El_Manar': 'المنار',
                'city_La_Soukra': 'السكرة',
                'city_Charguia': 'الشرڤيّة',
                'city_El_Ghazala': 'الغزالة',
                'city_Sidi_Bou_Said': 'سيدي بوسعيد',
            ...
            'en': {
                ...
                'city_Ariana': 'Ariana',
                'city_Ariana_Soughra': 'Ariana Soughra',
                'city_Nour_Jaafer': 'Nour Jaafer',
                'city_Ben_Arous': 'Ben Arous',
                'city_La_Marsa': 'La Marsa',
                'city_Megrine': 'Megrine',
                'city_El_Manar': 'El Manar',
                'city_La_Soukra': 'La Soukra',
                'city_Charguia': 'Charguia',
                'city_El_Ghazala': 'El Ghazala',
                'city_Sidi_Bou_Said': 'Sidi Bou Said',
                ...
                'city_Béja': 'Béja',
                'city_Jendouba': 'Jendouba',
                'city_Kef': 'Kef',
                'city_Mahdia': 'Mahdia',
                'city_Médenine': 'Médenine',    
